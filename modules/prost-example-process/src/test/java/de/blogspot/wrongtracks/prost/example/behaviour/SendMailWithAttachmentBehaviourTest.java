...
//	}
	...
	public static Option[] configuration() {
		...
		Option[] core = options(mavenBundle().groupId("org.activiti").artifactId("activiti-engine").version("5.12.1"),
				...
				mavenBundle().groupId("javax.mail").artifactId("com.springsource.javax.mail").version("1.4.5"),
...
//				mavenBundle().groupId("org.subethamail").artifactId("subethasmtp").version("3.1.7"),
